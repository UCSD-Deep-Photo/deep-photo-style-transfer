...
class Visualizer():
    ...
    def __init__(self, config):
        ...
        Parameters:
            config -- stores all the experiment flags; needs to be a subclass of BaseOptions
        ...
        self.use_html = config['isTrain'] and not config.get('no_html')
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            self.web_dir = os.path.join(config['checkpoints_dir'], config['model'], 'web')
            self.img_dir = os.path.join(self.web_dir, 'images')
            logging.info('create web directory %s...' % self.web_dir)
            util.mkdirs([self.web_dir, self.img_dir])
        # create a logging file to store training losses
        self.log_name = os.path.join(config['checkpoints_dir'], config['model'], 'loss_log.txt')
